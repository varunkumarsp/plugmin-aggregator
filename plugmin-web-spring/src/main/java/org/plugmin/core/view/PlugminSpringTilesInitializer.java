...
public class PlugminSpringTilesInitializer extends BasicTilesInitializer {

    public static final String PLUGMIN_TILES_CONTAINER_ATTRIBUTE = "org.apache.tiles.CONTAINER.Plugmin";
    ...
    protected String getContainerKey(TilesApplicationContext applicationContext) {
        return PLUGMIN_TILES_CONTAINER_ATTRIBUTE;
    }
    ...
    private class SpringTilesContainerFactory extends BasicTilesContainerFactory {
        ...
        protected void registerRequestContextFactory(String className, List<TilesRequestContextFactory> factories, TilesRequestContextFactory parent) {
            if (ClassUtils.isPresent(className, PlugminSpringTilesInitializer.class.getClassLoader())) {
        ...
        protected List<URL> getSourceURLs(TilesApplicationContext applicationContext,
            ...
            if (definitions != null) {
                ...
                URL url = PlugminSpringTilesInitializer.class.getClassLoader().getResource("META-INF/tiles/definitions.xml");
                result.add(url);
                return result;
            } else {
