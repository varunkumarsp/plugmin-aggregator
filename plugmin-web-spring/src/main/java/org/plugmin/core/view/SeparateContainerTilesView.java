...
import static org.plugmin.core.view.PlugminSpringTilesInitializer.PLUGMIN_TILES_CONTAINER_ATTRIBUTE;
...
public class SeparateContainerTilesView extends AbstractUrlBasedView {
    ...
    public boolean checkResource(final Locale locale) throws Exception {
        TilesContainer container = ServletUtil.getContainer(getServletContext(), PLUGMIN_TILES_CONTAINER_ATTRIBUTE);
    ...
    protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        TilesContainer container = ServletUtil.getContainer(servletContext, PLUGMIN_TILES_CONTAINER_ATTRIBUTE);
        if (container == null) {
