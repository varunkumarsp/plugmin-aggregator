package org.openxava.autocomplete;
...
public class MetaAutocomplete extends MetaElement implements java.io.Serializable, Cloneable {

	private static Log log = LogFactory.getLog(MetaAutocomplete.class);
	...
	private String id;
	private AutocompleteConfigVo config;
	
	public MetaAutocomplete() {
	}
	
	public MetaAutocomplete(MetaComponent component) {
		setMetaComponent(component);
	}

	public static MetaAutocomplete createDefault(MetaComponent component) throws Exception {
		MetaAutocomplete dd = new MetaAutocomplete();
		dd.setMetaComponent(component);
		dd.setValueProperty(defaultValueProperty(component.getMetaEntity()));
		return dd;
	}
	
	public static MetaAutocomplete createDefault(MetaModel metaModel) throws Exception { 
		MetaAutocomplete dd = new MetaAutocomplete();
	...
	public String toString() {
		return "MetaDropDown [defaultOrder=" + defaultOrder
				...
				+ ", metaComponent=" + getMetaComponent() + ", valueProperty=" + valueProperty
	...
	public AutocompleteConfigVo getConfig() {
		return config;
	}

	public void setConfig(AutocompleteConfigVo config) {
		if(config != null)
			this.config = config;
	}
