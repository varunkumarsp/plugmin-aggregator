...
import org.openxava.annotations.extended.ui.config.grid.Cell;
...
public class CellVo implements JsFieldValueResolver {
	...
	@CompositeField("dataSource")
	private List<Map<String, String>> dataSourceArray;
	...
	private JsField resolveDataSource() {
		...
		else if(CollectionUtils.isNotEmpty(dataSourceArray)) {
			return new JsFieldArray("dataSource", dataSourceArray.toArray(), "dataSource");
	...
	public List<Map<String, String>> getDataSourceArray() {
		return dataSourceArray;
	}

	public void setDataSourceArray(List<Map<String, String>> dataSourceArray) {
