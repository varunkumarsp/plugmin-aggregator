...
public class DatePickerConfigVo implements JsFieldValueResolver,
	...
	@DefaultValue("Current focused date is #=kendo.toString(data.current, 'D')#")
	...
	public DatePickerConfigVo(DatePickerConfig config) {
	...
	public void copyFrom(DatePickerConfig config) {
