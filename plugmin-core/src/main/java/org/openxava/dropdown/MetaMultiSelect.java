...
public class MetaMultiSelect extends MetaElement implements java.io.Serializable, Cloneable {

	private static Log log = LogFactory.getLog(MetaMultiSelect.class);
	...
	private String id;
	private MultiSelectConfigVo config;
	
	public MetaMultiSelect() {
	}
	
	public MetaMultiSelect(MetaComponent component) {
		setMetaComponent(component);
	}

	public static MetaMultiSelect createDefault(MetaComponent component) throws Exception {
		MetaMultiSelect dd = new MetaMultiSelect();
	...
	public static MetaMultiSelect createDefault(MetaModel metaModel) throws Exception { 
		MetaMultiSelect dd = new MetaMultiSelect();
	...
	public MultiSelectConfigVo getConfig() {
		return config;
	}

	public void setConfig(MultiSelectConfigVo dropDownConfig) {
