...
public class MetaComboBox extends MetaElement implements java.io.Serializable, Cloneable {

	private static Log log = LogFactory.getLog(MetaComboBox.class);
	...
	private String id;
	private ComboBoxConfigVo config;
	
	public MetaComboBox() {
	}
	
	public MetaComboBox(MetaComponent component) {
		setMetaComponent(component);
	}

	public static MetaComboBox createDefault(MetaComponent component) throws Exception {
		MetaComboBox dd = new MetaComboBox();
	...
	public static MetaComboBox createDefault(MetaModel metaModel) throws Exception { 
		MetaComboBox dd = new MetaComboBox();
	...
	public ComboBoxConfigVo getConfig() {
		return config;
	}

	public void setConfig(ComboBoxConfigVo config) {
		if(config != null)
			this.config = config;
	}
