...
public class MetaProperty extends MetaMember implements Cloneable {
	...
	private static final Map<String, String> JAVA_KENDO_TYPES = new HashMap<String, String>() {
		{
			put("java.lang.Integer", "number");
			put("java.lang.String", "string");
			put("java.lang.Boolean", "boolean");
			put("java.util.Calendar", "date");
			put("java.util.Date", "date");
		}
	};
	
	public String getKendoFieldType() throws Exception {
		String jtype = getTypeName();
		String ktype = JAVA_KENDO_TYPES.get(jtype);
		if(ktype == null)
			ktype = "String";
		return ktype;
	}
	
	public String getKendoFieldName() throws Exception {
